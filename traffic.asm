section .data
    ; --- 3-Light Tower Frames ---
    ; ANSI codes: [1;31m (Bright Red), [38;5;226m (Bright Yellow), [1;32m (Bright Green), [1;30m (Dark Gray)
    
    red_frame_msg db 0x1B, '[1;31m'
                  db '      .---------.      ', 0xA
                  db '    ."           ".    ', 0xA
                  db '   /      RED      \   ', 0xA
                  db '  |      STOP!      |  ', 0xA
    ...
    yellow_frame_msg db 0x1B, '[1;30m'
                  db '      .---------.      ', 0xA
                  db '    ."           ".    ', 0xA
                  db '   /               \   ', 0xA
                  db '  |                 |  ', 0xA
    ...
    all_off_frame_msg db 0x1B, '[1;30m'
                  db '      .---------.      ', 0xA
                  db '    ."           ".    ', 0xA
                  db '   /               \   ', 0xA
                  db '  |                 |  ', 0xA
